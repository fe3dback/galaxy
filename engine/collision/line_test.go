...
func TestLine2Line(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			l1A := engine.Vec{X: tt.a[0], Y: tt.a[1]}
			l1B := engine.Vec{X: tt.a[2], Y: tt.a[3]}
			l2A := engine.Vec{X: tt.b[0], Y: tt.b[1]}
			l2B := engine.Vec{X: tt.b[2], Y: tt.b[3]}
...
func TestLine2Circle(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			lA := engine.Vec{X: tt.args.line[0], Y: tt.args.line[1]}
